const socialLinks = [
    {
      href: 'https://github.com/prabhavpulipaka',
    ...
    {
      href: 'https://www.linkedin.com/in/prabhav-pulipaka-953b93220/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://x.com/prabhavpulipaka?s=21&t=JinDxBgdyRmBj5WZePQTew',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/prabhavpulipaka?igsh=MTJqejN2bmQwd3oyeQ%3D%3D&utm_source=qr',
        ...
        <section id="contact" className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch ">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    Connect with me today to collaborate and create impactful solutions for your organization's success!
                    </p>
                ...
                <form 
                action="https://getform.io/f/axoorrxb"
                method="POST" 
                className="xl:pl-10 2xl:pl-20">
                    ...
                    <div className="mb-4">
                        ...
                        required
                        className="text-field resize-y min-h-30 max-h-78">
